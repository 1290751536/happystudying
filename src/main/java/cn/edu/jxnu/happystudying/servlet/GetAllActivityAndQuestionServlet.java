...
@WebServlet(name = "GetAllActivityAndQuestionServlet", value = "/getall.do")
public class GetAllActivityAndQuestionServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (orderByType.equals("1")) {
            activityList = activityService.queryAllActivitySortByPublishTime();
            questionList = questionService.queryAllQuestionSortByPublishTime();
        } else {
            activityList = activityService.queryAllActivitySortByNumber();
            questionList = questionService.queryAllQuestionSortByNumber();
        }
