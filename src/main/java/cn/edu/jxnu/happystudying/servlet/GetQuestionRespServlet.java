...
@WebServlet(name = "GetQuestionRespServlet",value = "/getquestionresp.do")
public class GetQuestionRespServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<QuestionRespDomain> questionRespDomainList = questionRespService.queryById(qId);
