...
@WebServlet(name = "UpdateActivityIconServlet", value = "/user/updateactivityicon.do")
public class UpdateActivityIconServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String uploadPath = getServletContext().getRealPath("/front-desk-management/user/activity");
...
//            System.out.println(mp);
            ...
            activityService.updateIconById(id, iconPath.substring(iconPath.lastIndexOf("/")+1));
