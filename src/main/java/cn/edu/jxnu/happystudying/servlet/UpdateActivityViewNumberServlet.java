...
@WebServlet(name = "UpdateActivityViewNumberServlet", value = "/updateactivityviewnumber.do")
public class UpdateActivityViewNumberServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        activityService.updateViewNumberById(aId, x);
//        System.out.println(aId + x);
    }
}
