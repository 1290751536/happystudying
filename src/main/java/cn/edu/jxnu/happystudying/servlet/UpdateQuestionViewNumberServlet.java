...
@WebServlet(name = "UpdateQuestionViewNumberServlet",value = "/updatequestionviewnumber.do")
public class UpdateQuestionViewNumberServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        questionService.updateViewNumberById(aId, x);
    }
}
