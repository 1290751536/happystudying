...
layui.define(['layer', 'laytpl', 'form', 'element', 'upload', 'util'], function (exports) {
    ...
    var fly = {
        ...
        , layEditor: function (options) {
            var html = ['<div class="layui-unselect fly-edit">'
                , '<span>本编辑器支持mathjax公式</span>'
                , '<span type="tips"><i class="iconfont icon-lianjie"></i></span>'
            ...
            var log = {}, mod = {
                ...
                tips: function (editor) { //插入代码
                    layer.prompt({
                        title: '请根据Mathjax的格式贴入公式'
                        , formType: 2
                        , maxlength: 100
                        , shade: false
                        , id: 'LAY_flyedit_code'
    ...
    elemSigninHelp.on('click', function () {
        layer.open({
            ...
            , content: ['<div class="layui-text" style="padding: 20px;">'
                ...
                , , '<blockquote class="layui-elem-quote">天数/5向下取整加一后乘以5就是当天可获得的钻石数</blockquote>'
    ...
    $('.fly-search').on('click', function () {
        layer.open({
            ...
            , content: ['<form action="/front-desk-management/html/search.html">'
