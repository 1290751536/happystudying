...
layui.define('fly', function (exports) {
    ...
    form.on('select(column)', function (obj) {
        ...
        if (value === '0') {
            ...
            $('#getkiss').removeClass('layui-hide');
            $('#L_begin-time').addClass('layui-hide');
            $('#L_end-time').addClass('layui-hide');
        } else if (value === '99') {
            layer.tips('系统会对【活动】类型的帖子进行展示，但我们需要审核，通过后方可展示', obj.othis, tips);
            elemQuiz.removeClass('layui-hide');
            $('#getkiss').addClass('layui-hide');
            $('#L_begin-time').removeClass('layui-hide');
            $('#L_end-time').removeClass('layui-hide');
        }
    });
